...
- PyTorch `2.12.0+cu130`; CUTLASS DSL `4.6.0`; Transformers `5.13.1`; Mistral Common `1.11.5`; InstantTensor `0.1.5`; OpenAI `2.44.0`; compressed-tensors `0.17.0`; TileLang `0.1.9`; quack-kernels `0.6.2`; xgrammar `0.2.4`; Ninja `1.13.0`
